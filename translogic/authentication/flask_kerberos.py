...
'''
Flask Kerberos authentication using the GSSAPI
implementation is based on the original flask-kerberos implementation created by:
Michael Komitee ( https://github.com/mkomitee/flask-kerberos )
'''
